          ...
          <ul>
            ...
            <li>
              ...
              <p className="text-sm text-muted-foreground">
                ...
                by adding static type definitions, enabling better tooling,
            ...
            <li>
              ...
              <p className="text-sm text-muted-foreground">
                ...
                Tailwind CSS that provides accessible, customizable UI
                components with a modern design system approach.
              </p>
            </li>
            <li>
